"""CLI: turn a Confluence page, a web URL, or a local file into a two-host podcast MP3."""
...
def main() -> None:
    ...
    rendered = asyncio.run(render_dialogue(lines, voice_map=DEFAULT_VOICE_MAP))
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate a two-host podcast episode from a Confluence page, "
